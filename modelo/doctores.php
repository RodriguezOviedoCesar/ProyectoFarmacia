...
<head>
    ...
    <link rel="shortcut icon" href="../vista/imagenes/logo.png" type="image/x-icon">
    <link rel="stylesheet" type="text/css" href="../vista/otros/iconos/css/all.css">
    <link rel="stylesheet" href="../vista/otros/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" type = "text/css" href="../vista/css/doctores.css">
</head>
    ...
    <div id="contenedor">
        <div id="contenedordoctor">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end" style="margin-right: 150px;">
                ...
                <a href="../vista/contenido/index.php">
...
<head>
    <script type="text/javascript" src="../vista/otros/bootstrap/jquery-3.5.1.min.js"></script>
    <script type="text/javascript" src="../vista/otros/bootstrap/js/bootstrap.min.js"></script>
</head>
